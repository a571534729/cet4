...
import com.jayz.cet4.view.fragment.ReadFragment;
    ...
    private OnCheckedChangeListener checkChangerListener = new OnCheckedChangeListener() {
		...
		public void onCheckedChanged(RadioGroup group, int checkedId) {
			...
			case R.id.radio_grammar:
				...
				changeFragment(new GrammarFragment(MainActivity.this), fragmentManager);				
				break;
			case R.id.radio_read:
				tabhost.setCurrentTabByTag("read");
				changeFragment(new ReadFragment(MainActivity.this), fragmentManager);				
				break;
